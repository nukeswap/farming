  ...
  return (
    <Modal title={`Contribute ${currency}`} onDismiss={onDismiss}>
      <Box maxWidth="400px">
        ...
        />
        <Text as="p" mb="24px">
        If you don&apos;t contribute {currency}, you may not receive any IFO tokens at all and will only receive a full refund of your tokens.
        </Text>
