    ...
    <div>
      ...
      <LaunchIfoCallout>
        <div>
          ...
          <List>
            <li>{TranslateString(1, 'Have BUSD tokens in your wallet')}</li>
          </List>
          <Flex mb="16px">
            <LinkExternal href="https://dex.nukeswap.xyz/" mr="16px">
              {TranslateString(1, 'Buy BUSD')}
            </LinkExternal>
          </Flex>
          <Heading mb="16px">{TranslateString(600, 'During Sale')}:</Heading>
          <List>
            <li>{TranslateString(1, 'While the sale is live, commit your BUSD tokens to buy the IFO tokens')}</li>
          </List>
        ...
        <div>
          ...
          <div>
            ...
            <Text mb={3}>
              {TranslateString(
                1,
                'Launch your project with NukeSwap, to bring your token directly to the most active and rapidly growing community on BSC.',
              )}
            </Text>
            <Button
              as="a"
              href="https://nukeswap.com/launchpad/"
              external
            >
